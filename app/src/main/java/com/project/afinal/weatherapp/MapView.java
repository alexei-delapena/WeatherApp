...
/**
 * Created by DaljitSohi on 2017-12-09.
 */
...
public class MapView extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //Initially -> Default ground overlay will be the 'cloudsbar'
        bitmapDescriptor = BitmapDescriptorFactory.fromResource(R.raw.cloudbar);
...
//                        bitmapDescriptor = BitmapDescriptorFactory.fromResource(R.raw.cloudbar);
                    ...
                    case 1:
                        ...
                        tileOverlay.remove();
                        initMap();
//                        bitmapDescriptor = BitmapDescriptorFactory.fromResource(R.raw.snowbar);
                        break;
                    case 2:
                        tileType = "pressure_new";
                        tileOverlay.remove();
                        initMap();
//                        bitmapDescriptor = BitmapDescriptorFactory.fromResource(R.raw.pressurebar);
                        break;
                    case 3:
                        tileType = "wind_new";
                        tileOverlay.remove();
                        initMap();
//                        bitmapDescriptor = BitmapDescriptorFactory.fromResource(R.raw.windbar);
                        break;
                    case 4:
                        tileType = "temp_new";
                        tileOverlay.remove();
                        initMap();
//                        bitmapDescriptor = BitmapDescriptorFactory.fromResource(R.raw.temperaturebar);
                        break;
                }//end switch
...
/*
                ...
                mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(latLng.latitude, latLng.longitude), 5f)); //Move the Camera to the Marker
*/
    ...
    private void groundOverlay(BitmapDescriptor bar_Descriptor){
        LatLng placeOverlayHere = new LatLng(-28.711353, -14.507741);
        GroundOverlayOptions groundOverlayOptions = new GroundOverlayOptions()
                .image(bar_Descriptor)
                .position(placeOverlayHere, 100f, 50f);
