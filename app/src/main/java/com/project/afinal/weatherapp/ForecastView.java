...
//        forecastList = new ArrayList<>();
        ...
        //Two 'Forecast' objects for demo purposes
//        Forecast forecastFriday = new Forecast("0", "-5", "Snow", "Friday, December 8");
//        Forecast forecastSaturday = new Forecast("0", "-3", "Cloudy", "Saturday, December 9");
//        forecastList.add(forecastFriday);
//        forecastList.add(forecastSaturday);

        FetchForecastData fetchWeatherData = new FetchForecastData();
        fetchWeatherData.execute(weatherAPI_url);
